  ...
  <div class="min-vh-100 bg-light d-flex align-items-center justify-content-center p-4">
    <div class="card border-0 shadow-sm p-4 w-100" style="max-width: 400px; border-radius: 1rem;">
      ...
      <div class="text-center mb-4">
        <h1 class="h4 fw-bold text-dark">Doctor Login</h1>
      </div>
      ...
      <div class="mt-4 pt-4 text-center">
        <RouterLink to="/" class="small text-secondary text-decoration-none">
          &larr; Back To Home
        </RouterLink>
      </div>
    </div>
...
async function handleLogin() {
  ...
  try {
    await auth.loginDoctor(username.value, password.value)
